...
const { index, getItem, storeItem, updatedItem, deletedItem, activeUser } = require('../controllers/UserController');
...
router.post('/', [checkAuth, checkRoleAuth()], storeItem); //TODO: localhost/users/ ---> lista 
