...
const { index, indexFreeProperty, getItem, createdItem, updatedItem, deletedItem, documentsEstate } = require('../controllers/RealEstateDataController');
...
router.get('/documentsEstate', [checkAuth, checkRoleAuth()], documentsEstate);
